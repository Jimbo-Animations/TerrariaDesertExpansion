...
namespace TerrariaDesertExpansion.Content.Items.Placeables.Relics
{
    class MegaCactusSlimeRelic : ModItem
    {
        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(TileType<MegaCactusSlimeRelicPlaced>(), 0);
    ...
    class MegaCactusSlimeRelicPlaced : ModTile
    {
        ...
        public virtual string RelicTextureName => "TerrariaDesertExpansion/Content/Items/Placeables/Relics/MegaCactusSlimeRelicPlaced";

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "TerrariaDesertExpansion/Content/Items/Placeables/Relics/RelicPedestal";
