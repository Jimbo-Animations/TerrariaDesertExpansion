...
{
    class PharaohRelic : ModItem
    {
        public override void SetDefaults()
        {
            Item.DefaultToPlaceableTile(TileType<PharaohRelicPlaced>(), 0);
    ...
    class PharaohRelicPlaced : ModTile // 99% from Examplemod
    {
        ...
        public virtual string RelicTextureName => "TerrariaDesertExpansion/Content/Items/Placeables/Relics/PharaohRelicPlaced";
